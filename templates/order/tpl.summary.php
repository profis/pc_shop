	<div id="cart_prices">
		...
		<div class="clear"></div>
		<?php } ?>
		<div class="full_price"><?php echo $this->core->Get_plugin_variable('cart_full_price', $this->plugin_name) ?>: <span><span id="fprice"><?php echo number_format($cart_data["full_price"], 2, ",", "") ?></span> <?php echo $this->price->get_user_currency() ?></span></div>
		<div class="clear"></div>
