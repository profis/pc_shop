...
-- 
-- Host: localhost
-- Generation Time: Dec 03, 2012 at 11:34 AM
...
CREATE TABLE `pc_shop_categories` (
  ...
  KEY `lft` (`lft`),
  KEY `rgt` (`rgt`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=737 ;
...
CREATE TABLE `pc_shop_item_attributes` (
  ...
  PRIMARY KEY (`id`),
  KEY `item_id` (`item_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=15534 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=3418 ;
