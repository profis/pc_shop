...
-- 
-- Host: localhost
-- Generation Time: Jan 02, 2013 at 05:12 PM
...
CREATE TABLE `pc_shop_categories` (
  ...
  KEY `lft` (`lft`),
  KEY `rgt` (`rgt`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=780 ;
...
CREATE TABLE `pc_shop_item_attributes` (
  ...
  PRIMARY KEY (`id`),
  KEY `item_id` (`item_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=15597 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=3445 ;
